---
title: "Tailwind CSSでCSSが苦手なエンジニアでもイイ感じのサイトが作れることを伝えたい"
date: "2020-05-31T17:02:00.000Z"
updatedAt: ""
template: "post"
draft: false
slug: "/posts/recommendation-developers-use-tailwind-css-for-styling"
category: "How To"
tags:
    - "Tailwind CSS"
description: "Tailwind CSSの設計思想、使い方、実際に使ってみた感想、ユースケース、メリット・デメリットを紹介していきます。"
socialImage: "/media/2020/5/31/0.png"
---

![Tailwind CSSのサイトのトップページ](/media/2020/5/31/0.png)
...
関連記事: [LaravelにTailwind CSSを導入する](/posts/how-to-set-up-tailwindcss-on-laravel)

## Tailwind CSSの特徴

Tailwind CSSは以下のような特徴を持っています。
...
![黒くて丸いトップに戻るボタン](/media/2020/5/31/1.png)
...
また、それぞれのクラス名と対応する値は公式ドキュメントに掲載されています。興味のある方は、一例として[padding](https://Tailwind CSS.com/docs/padding/#app)を見てみてください。
...
![A utility-first CSS framework for rapidly building custom designs.](/media/2020/5/31/2.png)
...
ヘッダーは`<div className="h-16 flex items-center md:max-w-screen-md md:mx-auto">`のように書いています。これは`max-w-screen-md mx-auto`はmd以上の幅でスタイルが当たるということを示しています。

![サイトのヘッダー](/media/2020/5/31/3.png)
...
![CDを紹介するカードコンポーネント](/media/2020/5/31/4.png)
...
![動画に対するコメント](/media/2020/5/31/5.png)
...
![DJ松永のプロフィールページ](/media/2020/5/31/6.png)
...
もう１つデメリットを強いて挙げると、**細かい調整をするときはCSSを書く必要があるので、そのCSSがいつの間にか肥大化しないように監視を続ける必要があるのかなと思います。**
...
Tailwind CSSでは基本的に命名をしないので、どれがModifierの命名に頭を悩ませることもなく、レビューを受けてクラス名を変更する手間もありません。エンジニアが思考停止でスタイルを当てられる恩恵は少なくないでしょう。脳のリソースはサーバーサイドやフロントエンドのクリーンな設計に回してください。
...
![Laravel Vapor トップページ](/media/2020/5/31/7.png)

**さて、Tailwind CSSはCSSを当てるための１つの手段です。あくまで素晴らしいデザインをシンプルに実現し、スタイルの管理を追求するためのツールです。その成果はサイトをデザインするデザイナー、そして実装するエンジニアの手に掛かっています。**
