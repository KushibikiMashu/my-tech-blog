...
![Next.jsとTailwind CSSのロゴ](/media/2020/6/27/2020_6_27__0.png)
...
**また、[Tailwind CSS](https://tailwindcss.com/)はユーティリティファーストのCSSフレームワークです。**その特徴は、Tailwind CSSによって提供されるクラスを組み合わせてコンポーネントを作り、サイトをデザインしていくところにあります。さらにCSSフレームワークなので、CSSに慣れていない人でも簡単に使うことができます。
...
![index.jsxページ](/media/2020/6/27/2020_6_27__1.png)
