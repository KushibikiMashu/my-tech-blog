...
<div class="explain">
  ...
  <div class="explain__paragraphWrapper">
    <p class="explain__paragraphContent">和田さんは<a href="https://amzn.to/34yikq1" target="_blank">「テスト駆動開発」</a>（Kent Beck著）の翻訳者だよ。ちなみに、Kent Beckはアジャイルの源流となるエクストリーム・プログラミングの提唱者で、今はFacebookで働いているよ。</p>
  </div>
</div>
